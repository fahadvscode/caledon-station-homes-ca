...
const inputClass =
  "mt-1.5 w-full rounded-sm border border-border bg-white px-3 py-2.5 text-text-primary";
...
export function LeadForm({
  ...
  return (
    ...
    >
      ...
      >
        {form.formState.isSubmitting ? "Submitting…" : "Register for investor updates"}
      </button>
